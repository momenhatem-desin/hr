...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  بيانات  إضافى أيام  للرواتب 
         ...
         <tbody>
            ...
            <tr>
               ...
               <td> @if($info->is_open==1) مفتوح @elseif ($info->is_open==2)  مغلق و مؤرشف @else  بأنتظار الفتح 
                 @endif
                  @if($info->is_open !=0)
                 <a href="{{ route('Main_salary_employees_addtion.show',$info->id) }}"  class="btn  btn-success btn-sm"> عرض </a>
