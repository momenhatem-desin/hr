...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  تعديل بيانات الموظف
         </h3>
      </div>
      <div class="card-body">
      ...
      <div class="card-body">
        ...
        <div class="tab-content" id="custom-content-below-tabContent">
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input autofocus type="text" name="zketo_code" id="zketo_code" class="form-control" value="{{ old('zketo_code',$data['zketo_code']) }}" >
                     @error('zketo_code')
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label>    اسم الموظف  كاملا<span style="color:red;">*</span></label>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <option   @if(old('emp_gender',$data['emp_gender'])==1) selected @endif  value="1">ذكر</option>
                     <option @if(old('emp_gender',$data['emp_gender'])==2 ) selected @endif value="2">انثي</option>
                     </select>
                     @error('emp_gender')
                     <span class="text-danger">{{ $message }}</span> 
                     @enderror
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="branch_id" id="branch_id" class="form-control select2 ">
                        ...
                        <option @if(old('branch_id',$data['branch_id'])==$info->id) selected="selected" @endif value="{{ $info->id }}"> {{ $info->name }} </option>
                        @endforeach
                        @endif
                     </select>
                     @error('branch_id')
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="Qualifications_id" id="Qualifications_id  " class="form-control select2 ">
                        <option value="">اختر المؤهل <span style="color:red;">*</span></option>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="Qualifications_year" id="Qualifications_year" class="form-control" value="{{ old('Qualifications_year',$data['Qualifications_year']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <option @if(old('graduation_estimate',$data['graduation_estimate'])==1) selected @endif  value="1">مقبول</option>
                     <option @if(old('graduation_estimate',$data['graduation_estimate'])==2 ) selected @endif value="2">جيد</option>
                     <option @if(old('graduation_estimate',$data['graduation_estimate'])==3 ) selected @endif value="3">جيد مرتفع</option>
                     <option @if(old('graduation_estimate',$data['graduation_estimate'])==4 ) selected @endif value="4">جيد جداً</option>
                     <option @if(old('graduation_estimate',$data['graduation_estimate'])==5 ) selected @endif value="5">إمتياز </option>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="text" name="Graduation_specialization" id="Graduation_specialization" class="form-control" value="{{ old('Graduation_specialization',$data['Graduation_specialization']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="date" name="brith_date" id="brith_date" class="form-control" value="{{ old('brith_date',$data['brith_date']) }}" >
                     @error('brith_date')
                     <span class="text-danger">{{ $message }}</span> 
                     @enderror
                  </div>
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label>         رقم بطاقة الهوية <span style="color:red;">*</span></label>
                     <input type="text" name="emp_national_idenity" id="emp_national_idenity" class="form-control" value="{{ old('emp_national_idenity',$data['emp_national_idenity']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label>         مركز اصدار بطاقة الهوية  <span style="color:red;">*</span></label>
                     <input type="text" name="emp_identityPlace" id="emp_identityPlace" class="form-control" value="{{ old('emp_identityPlace',$data['emp_identityPlace']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     <label>         تاريخ انتهاء بطاقة الهوية <span style="color:red;">*</span></label>
                     <input type="date" name="emp_end_identityIDate" id="emp_end_identityIDate" class="form-control" value="{{ old('emp_end_identityIDate',$data['emp_end_identityIDate']) }}" >
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="emp_lang_id" id="emp_lang_id" class="form-control select2 ">
                        <option value="">اختر اللغة  <span style="color:red;">*</span></option>
               ...
               <div class="col-md-4 related_miltary_1" @if(old('emp_military_id',$data['emp_military_id'])!=1)   style="display: none;" @endif>
                  <div class="form-group">
                     ...
                     <input type="date" name="emp_military_date_from" id="emp_military_date_from" class="form-control" value="{{ old('emp_military_date_from',$data['emp_military_date_from']) }}" >
               ...
               <div class="col-md-4 related_miltary_1" @if(old('emp_military_id',$data['emp_military_id'])!=1)   style="display: none;" @endif>
                  <div class="form-group">
                     ...
                     <input type="date" name="emp_military_date_to" id="emp_military_date_to" class="form-control" value="{{ old('emp_military_date_to',$data['emp_military_date_to']) }}" >
               ...
               <div class="col-md-4 related_miltary_1" @if(old('emp_military_id',$data['emp_military_id'])!=1)   style="display: none;" @endif>
                  <div class="form-group">
                     ...
                     <input type="text" name="emp_military_wepon" id="emp_military_wepon" class="form-control" value="{{ old('emp_military_wepon',$data['emp_military_wepon']) }}" >
               ...
               <div class="col-md-4 related_miltary_2" @if(old('emp_military_id',$data['emp_military_id'])!=2)   style="display: none;" @endif>
                  <div class="form-group">
                     ...
                     <input type="date" name="exemption_date" id="exemption_date" class="form-control" value="{{ old('exemption_date',$data['exemption_date']) }}" >
               ...
               <div class="col-md-4 related_miltary_2" @if(old('emp_military_id',$data['emp_military_id'])!=2)   style="display: none;" @endif>
                  <div class="form-group">
                     ...
                     <input type="text" name="exemption_reason" id="exemption_reason" class="form-control" value="{{ old('exemption_reason',$data['exemption_reason']) }}" >
               ...
               <div class="col-md-4 related_miltary_3" @if(old('emp_military_id',$data['emp_military_id'])!=3)   style="display: none;" @endif>
                  <div class="form-group">
                     ...
                     <input type="text" name="postponement_reason" id="postponement_reason" class="form-control" value="{{ old('postponement_reason',$data['postponement_reason']) }}" >
          ...
          <div class="tab-pane fade" id="custom-content-jobs_data" role="tabpanel" aria-labelledby="jobs_data">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  <label>  هل  له بصمة حضور وانصراف <span style="color:red">*</span></label>
            ...
            <div class="col-md-4">
               <div class="form-group">
                 ...
                 <option @if(old('is_has_fixced_shift',$data['is_has_fixced_shift'])=="0") selected @endif value="0">لا</option>
            ...
            <div class="col-md-4 " id="MotivationDIV" @if(old('MotivationType',$data['MotivationType'])!=1) style="display: none;" @endif >
               <div class="form-group">
                  <label> قيمة الحافز الشهري الثابت <span style="color:red">*</span></label>
            ...
            <div class="col-md-4 relatedisSocialnsurance" " @if(old('isSocialnsurance',$data['isSocialnsurance'])!=1) style="display: none;" @endif  >
               <div class="form-group">
                  <label> رقم التامين الاجتماعي للموظف <span style="color:red">*</span></label>
                  <input type="text" name="SocialnsuranceNumber" id="SocialnsuranceNumber" class="form-control" value="{{ old('SocialnsuranceNumber',$data['SocialnsuranceNumber']) }}" >
            ...
            <div class="col-md-4 relatedismedicalinsurance" " @if(old('ismedicalinsurance',$data['ismedicalinsurance'])!=1) style="display: none;" @endif  >
               <div class="form-group">
                  <label> قيمة التأمين الطبي المستقطع شهرياً  <span style="color:red">*</span></label>
            ...
            <div class="col-md-4 " >
               <div class="form-group">
                  ...
                  <input type="text" name="urgent_person_details" id="urgent_person_details" class="form-control" value="{{ old('urgent_person_details',$data['urgent_person_details']) }}" >
    ...
    <!-- /.card -->
            ...
            <div class="col-md-12">
               <div class="form-group text-center">
                  <button class="btn btn-sm btn-success" type="submit" name="submit"> تحديث بيانات الموظف </button>
