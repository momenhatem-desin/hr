        ...
        <div class="tab-content" id="custom-content-below-tabContent">
          ...
          <br>
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <select name="country_id" id="country_id" class="form-control select2 ">
                        ...
                        <option @if(old('country_id')==$info->id) selected="selected" @endif value="{{ $info->id }}"> {{ $info->name }} </option>
                        @endforeach
                        @endif
                     </select>
                     @error('country_id')
                  ...
                  <div class="form-group" id="governorates_Div">
                     ...
                     <select name="governorates_id" id="governorates_id" class="form-control select2 ">
                        <option value="">اختر المحافظة التابع لها الموظف</option>
                           ...
                           <option @if(old('governorates_id')==$info->id) selected="selected" @endif value="{{ $info->id }}"> {{ $info->name }}
                           </option>
                           @endforeach
                           @endif
                     </select>
               ...
               <div class="col-md-4 related_miltary_1" @if(old('emp_military_id')!=1)   style="display: none;" @endif>
                  <div class="form-group">
               ...
               <div class="col-md-4 related_miltary_2" @if(old('emp_military_id')!=2)   style="display: none;" @endif>
                  <div class="form-group">
               ...
               <div class="col-md-4 related_miltary_3" @if(old('emp_military_id')!=3)   style="display: none;" @endif>
                  <div class="form-group">
               ...
               <div class="col-md-4 related_does_has_Driving_License"   @if(old('does_has_Driving_License')!=1)   style="display: none;" @endif>
                  <div class="form-group">
               ...
               <div class="col-md-8 Related_Relatives_detailsDiv"   @if(old('has_Relatives')!=1)   style="display: none;" @endif>
                  <div class="form-group">
               ...
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <option @if(old('is_Disabilities_processes')==0 and old('is_Disabilities_processes')!="" ) selected @endif value="0">لا</option>
               ...
               <div class="col-md-8 Related_is_Disabilities_processesDiv" @if(old('is_Disabilities_processes')!=1)   style="display: none;" @endif>
                  <div class="form-group">
          ...
          <div class="tab-pane fade" id="custom-content-jobs_data" role="tabpanel" aria-labelledby="jobs_data">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <select name="emp_Departments_code" id="emp_Departments_code" class="form-control select2 ">
                     ...
                     <option @if(old('emp_Departments_code')==$info->id) selected="selected" @endif value="{{ $info->id }}"> {{ $info->name }} </option>
                     @endforeach
                     @endif
                  </select>
            ...
            <div class="col-md-4 relatedfixced_shift"  @if(old('is_has_fixced_shift')==0 or old('is_has_fixced_shift')=="") style="display: none;" @endif>
               <div class="form-group">
            ...
            <div class="col-md-4" id="daily_work_hourDiv"   @if(old('is_has_fixced_shift')==1 || old('is_has_fixced_shift')=="") style="display: none;" @endif>
               <div class="form-group">
            ...
            <div class="col-md-4 " id="MotivationDIV" @if(old('MotivationType')!=1) style="display: none;" @endif >
               <div class="form-group">
            ...
            <div class="col-md-4 relatedisSocialnsurance" " @if(old('isSocialnsurance')!=1) style="display: none;" @endif  >
               <div class="form-group">
            ...
            <div class="col-md-4 relatedismedicalinsurance" " @if(old('ismedicalinsurance')!=1) style="display: none;" @endif  >
               <div class="form-group">
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <select  name="Does_have_fixed_allowances" id="Does_have_fixed_allowances" class="form-control">
                     <option value="">اختر الحالة</option>
                  <option   @if(old('Does_have_fixed_allowances')==1) selected @endif  value="1">نعم</option>
                  <option @if(old('Does_have_fixed_allowances')==0 and old('Does_have_fixed_allowances')!="" ) selected @endif value="0"> لا </option>
            ...
            <div class="col-md-4">
               <div class="form-group">
                  ...
                  <select  name="is_active_for_Vaccation" id="is_active_for_Vaccation" class="form-control">
                     <option value="">اختر الحالة</option>
                  <option   @if(old('is_active_for_Vaccation')==1) selected @endif  value="1">نعم له سنوى</option>
                  <option   @if(old('is_active_for_Vaccation')==2) selected @endif  value="2">نعم له رصيد عن طريق ايام الحصور</option>
                  <option   @if(old('is_active_for_Vaccation')==0 and old('is_active_for_Vaccation')!=""  ) selected @endif  value="0">ليس له رصيد</option>
               </select>
