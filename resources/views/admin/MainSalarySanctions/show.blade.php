...
<a href="{{ route('MainSalarySanctions.index') }}">  جزاءات الايام  </a>
@endsection
...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">   بيانات  جزاءات الايام  للرواتب الشهر المالى({{ $finance_cln_periods_data['month']->name }}لسنة {{ $finance_cln_periods_data['FINANCE_YR'] }})
      ...
      <div class="row" style="padding: 5px;">
           ...
           <div class="col-md-3">
               <div class="form-group">
                  ...
                  <option  value="all">بحث بنوع الجزاء</option>
      ...
      <div class="card-body" id="ajax_responce_serachDiv" style="padding: 0px 5px">
         ...
         <tbody>
            ...
            @endif
               ...
               <td> 
                 @if($info->sanctions_type==1)جزاء ايام @elseif($info->sanctions_type==2)جزاء بصمة @elseif($info->sanctions_type==3) جزاء تحقيق @else لم يحدد @endif
               </td>
                <td> {{ $info->value*1}} </td>
               <td> {{ $info->total*1}} </td>
                <td>
