...
<head>
   ...
   <title>بحث بالسلفه الشهرية  الرواتب</title>
   ...
   <table style="width: 60%;float: right;  margin-right: 5px;" dir="rtl">
      ...
      <tr>
         <td style="text-align: center;padding: 5px;font-weight: bold;"> <span style=" display: inline-block;
               ...
               بحث  بالسلف الشهرية الرواتب بالشهر المالى ({{ $finance_cln_periods_data['month']->name }}لسنة {{ $finance_cln_periods_data['FINANCE_YR'] }})
            </span>
         </td>
      </tr>
      <tr>
