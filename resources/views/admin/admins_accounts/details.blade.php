         ...
         <div class="card-body">
            ...
            <div class="card-header">
               <h3 class="card-title card_title_center">الخزن  المضافة لصلاحية المستخدم ( {{ $data['name'] }} )  
                  @if( auth()->user()->is_master_admin==1 or check_permission_sub_menue_actions(160))
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           @if( auth()->user()->is_master_admin==1 or check_permission_sub_menue_actions(160))
                           <a href="{{ route('admin.admins_accounts.delete_treasuries',['rowid'=>$info->id,'userid'=>$data['id'] ]) }}" class="btn btn-sm btn-danger are_you_sure">حذف</a>
                            @endif
                        </td>
                     </tr>
                     @php
   ...
   <table id="example2" class="table table-bordered table-hover">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               @if( auth()->user()->is_master_admin==1 or check_permission_sub_menue_actions(160)) 
               <a href="{{ route('admin.admins_accounts.delete_stores',['rowid'=>$info->id,'userid'=>$data['id'] ]) }}" class="btn btn-sm btn-danger are_you_sure">حذف</a>
               @endif
            </td>
         </tr>
         @php
