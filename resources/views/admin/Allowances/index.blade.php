...
<div class="col-12">
   <div class="card">
      <div class="card-header">
         <h3 class="card-title card_title_center">  بيانات  أنواع  البدلات للراتب 
            <a href="{{ route('Allowances.create') }}" class="btn btn-sm btn-warning">اضافة جديد</a>
         </h3>
      </div>
         ...
         <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <a  href="{{ route('Allowances.edit',$info->id) }}" class="btn btn-success btn-sm">تعديل</a>
                     <a  href="{{ route('Allowances.destroy',$info->id) }}" class="btn are_you_shur  btn-danger btn-sm">حذف</a>
                  </td>
               </tr>
               @endforeach
            </tbody>
