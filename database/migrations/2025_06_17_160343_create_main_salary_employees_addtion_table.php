...
return new class extends Migration
{
    ...
    {
        Schema::create('main_salary_employees_addtion', function (Blueprint $table) {
           $table->id();
           $table->integer('is_auto')->comment("هل تلقائى من النظام ام بشكل يدوى");
            ...
            $table->foreignId('addtion_types_id')->references('id')->on('additional_types')->onUpdate('cascade')->comment("نوع الاضافة");
            $table->decimal("total",10,2)->comment("أجمالى الاضافى")->default('0'); 
    ...
    {
        Schema::dropIfExists('main_salary_employees_addtion');
    }
};
