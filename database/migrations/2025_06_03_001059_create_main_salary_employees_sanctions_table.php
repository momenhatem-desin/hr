...
return new class extends Migration
{
    ...
    {
        Schema::create('main_salary_employees_sanctions', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('sanctions_type')->comment("واحد جزاء ايام اثنين بصمة ");
            $table->decimal("value",10,2)->comment("كم يوم جزاء")->default('0');
            $table->decimal("total",10,2)->comment("أجمالى الجزاء")->default('0'); 
    ...
    {
        Schema::dropIfExists('main_salary_employees_sanctions');
    }
};
