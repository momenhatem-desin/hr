...
return new class extends Migration
{
    ...
    {
        Schema::create('main_salary_employees_discound', function (Blueprint $table) {
          $table->id();
           $table->integer('is_auto')->comment("هل تلقائى من النظام ام بشكل يدوى");
            ...
            $table->foreignId('discound_types_id')->references('id')->on('discount_types')->onUpdate('cascade')->comment("نوع الخصم");
            $table->decimal("total",10,2)->comment("أجمالى الخصم")->default('0'); 
    ...
    {
        Schema::dropIfExists('main_salary_employees_discound');
    }
};
