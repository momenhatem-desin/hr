...
return new class extends Migration
{
    ...
    {
        Schema::create('main_salary_employees_allowances', function (Blueprint $table) {
          $table->id();
            ...
            $table->foreignId('allowances_id')->references('id')->on('allowances')->onUpdate('cascade')->comment("نوع  البدل");
            $table->decimal("total",10,2)->comment("أجمالى البدل")->default('0'); 
    ...
    {
        Schema::dropIfExists('main_salary_employees_allowances');
    }
};
