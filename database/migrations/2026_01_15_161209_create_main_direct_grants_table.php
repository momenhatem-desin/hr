...
return new class extends Migration
{
    ...
    {
        Schema::create('main_direct_grants', function (Blueprint $table) {
             $table->id();
            ...
            $table->foreignId('grants_id')->references('id')->on('grants')->onUpdate('cascade')->comment("نوع المنحه ");
            $table->decimal("total",10,2)->comment("أجمالى المنحه")->default('0'); 
    ...
    {
        Schema::dropIfExists('main_direct_grants');
    }
};
