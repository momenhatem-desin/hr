$(document).ready(function() {
      ...
      $(document).on('click', '.load_add_roles_actions', function(e) {
    
        var id=$(this).data('id');
          var token_search = $("#token_search").val();
          var ajax_url = $("#ajax_search_load_add_roles_actions").val();
          ...
          jQuery.ajax({
              ...
              $("#load_add_roles_actionsModalBody").html(data);
              $("#load_add_roles_actionsModal").modal("show");
              $('.select2').select2({
                theme: 'bootstrap4'
              });  
